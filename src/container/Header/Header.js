    ...
    <div id="home" className='app__header app__flex'>
        ...
        >
          ...
          <div className='app__header-badge'>
            ...
            <div class="tag-cmp app__flex" id="cv"><a href="https://drive.google.com/file/d/1qHXjf8YLn_82cPKs5Vll_SdzxvWVE2Cw/view?usp=sharing" target="_blank" class="p-text bold-text aref"> MY RESUME <svg stroke="currentColor"  stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" stroke="#000" stroke-width="2" d="M2.99787498,0.999999992 L17.4999998,0.999999992 L20.9999998,4.50000005 L21,23 L3,23 L2.99787498,0.999999992 Z M16,1 L16,6 L21,6 M12,9 L12,18 M8,15 L12,19 L16,15"></path></svg></a></div>
        ...
        <div className='app__header-react'>
          ...
          <img className='header-myImage' src={images.myImage} />
